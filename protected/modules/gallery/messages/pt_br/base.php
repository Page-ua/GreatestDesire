...
return array (
  ...
  'Size:' => 'Tamanho:',
  'There are no galleries available for this space. In order to configure the gallery snippet, please <a href="{createLink}">create</a> a new gallery' => 'Não existe galeria disponível para esse espaço. Para poder configurar um fragmento da galeria, por favor, <a href="{createLink}">crie</a> uma nova galeria',
